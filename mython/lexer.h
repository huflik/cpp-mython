...
namespace parse {
	...
	public:
		...
		const T& Expect() const {
			...
			if (!current_token.Is<T>()) {
				throw LexerError("Error token type"s);
			}
		...
		void Expect(const U& value) const {
			using namespace std::literals;
			const Token& current_token{ CurrentToken() };
			if (!(current_token.Is<T>() && current_token.As<T>().value == value)) {
				throw LexerError("Error token type or token value "s);
			}
		}
	...
	private:
		...
		bool no_tokens_ = true;
		int indent_ = 0;
		int line_indent_ = 0;
		
		token_type::Number ReadNumber();
		token_type::String ReadString();
		Token ReadId();
		Token ReadIndent();
		void DiscardUseless();
	};
	...
	using namespace std::literals;
	static const std::unordered_map<std::string, Token> map_lexems{
		{ "class"s, token_type::Class{} }, { "return"s, token_type::Return{} },
		{ "if"s, token_type::If{} }, { "else"s, token_type::Else{} },
		{ "def"s, token_type::Def{} }, { "print"s, token_type::Print{} },
		{ "and"s, token_type::And{} }, { "or"s, token_type::Or{} },
		{ "not"s, token_type::Not{} }, { "None"s, token_type::None{} },
		{ "True"s, token_type::True{} }, { "False"s, token_type::False{} },
